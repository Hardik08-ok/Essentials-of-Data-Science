...
print("Average Marks of S1 and S2", np.round(np.mean(a[:, [1, 2]], axis=0), 1))
...
# 18
print(
    "Count of students in each subject who got marks >= 90:",
    np.sum(a[:, 1:] >= 90, axis=0),
)
# 19
print("Roll no:", a[:, 0])
print(
    "Count of subjects in which student got marks >= 90:",
